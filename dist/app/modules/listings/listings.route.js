...
router.get("/:id", listings_controller_1.getSingleListing);
router.post("/", (0, auth_1.auth)([users_interface_1.Role.ADMIN, users_interface_1.Role.GUIDE]), fileUploader_1.fileUploader.upload.array("files", 5), (req, res, next) => {
